...
?>
	...
	<p>
		Below are your configuration values. If you would like to change anything, edit config.php. Each value's purpose is
		described in config.php.
	</p>
	...
	<form name="setupform" id="setupform" method="post" action="setup.php">
		...
		<div align="center">
			<table cellpadding="3" class="partbox">
				...
				<tr>
					<td colspan="2">
						<p>
							This installation of the Gift Registry is not complete. Please create the initial administrator user, name
							the default family, then click Submit.
						</p>
					</td>
				</tr>
				<tr>
					...
					<td>
						<input id="username" name="username" size="20" maxlength="20" type="text"
		...
		echo htmlspecialchars($_POST["username"]); ?>" />
				...
				<tr>
					...
					<td>
						<input id="fullname" name="fullname" size="30" maxlength="50" type="text"
		...
		echo htmlspecialchars($_POST["fullname"]); ?>" />
				...
				<tr>
					...
					<td>
						<input id="email" name="email" size="30" maxlength="255" type="text"
		...
		echo htmlspecialchars($_POST["email"]); ?>" />
				...
				<tr valign="top">
					...
					<td>
						<input id="familyname" name="familyname" size="50" maxlength="255" type="text"
							value="<?php if (isset($_POST["familyname"]))
		echo htmlspecialchars($_POST["familyname"]); ?>" />
					</td>
				</tr>
				<tr>
